...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Gift.source'
        db.delete_column('wedding_gift', 'source_id')

        # Deleting field 'Gift.thank_you_sent'
        db.delete_column('wedding_gift', 'thank_you_sent')


    def backwards(self, orm):
        # Adding field 'Gift.source'
        db.add_column('wedding_gift', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['wedding.Invitee']),
                      keep_default=False)

        # Adding field 'Gift.thank_you_sent'
        db.add_column('wedding_gift', 'thank_you_sent',
    ...
    models = {
        ...
        'wedding.gift': {
            ...
            'sources': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['wedding.Invitee']", 'through': "orm['wedding.ThankYou']", 'symmetrical': 'False'}),
