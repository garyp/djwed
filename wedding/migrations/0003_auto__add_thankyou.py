...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('wedding_thankyou', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('gift', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wedding.Gift'], null=True)),
            ('invitee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wedding.Invitee'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('sent', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal('wedding', ['ThankYou'])


    def backwards(self, orm):
        # Deleting model 'ThankYou'
        db.delete_table('wedding_thankyou')
